            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input
                        ...
                        id="new-password"
                        placeholder="* * * * * * * *"
                        class="w-full rounded-[10px] border border-gray-300 bg-white py-3 pl-11 pr-11 text-xs sm:text-sm text-gray-800 placeholder:text-gray-400 focus:outline-none transition shadow-2xs"
