...
<body class="min-h-screen lg:h-screen lg:overflow-hidden bg-[#F6F7F9] dark:bg-[#282A2C] font-sans antialiased text-gray-900 dark:text-gray-100 selection:bg-blue-100 selection:text-blue-600 flex flex-col justify-between transition-colors duration-200">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-3.5 sm:gap-4 lg:gap-3.5 items-stretch lg:flex-1 lg:min-h-0">
            ...
            <div class="lg:col-span-8 flex flex-col gap-3.5 sm:gap-4 lg:gap-3.5 lg:min-h-0">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-2.5 sm:gap-3.5 shrink-0">
                    ...
                    <div class="rounded-2xl sm:rounded-3xl bg-white dark:bg-[#1F2123] p-3 sm:p-4 shadow-[0_2px_10px_rgba(0,0,0,0.02)] dark:shadow-none border border-gray-100/90 dark:border-white/5 flex flex-col justify-between h-[105px] sm:h-[130px] transition hover:shadow-md dark:hover:border-white/10">
                        <div class="flex items-start justify-between">
                            ...
                            <div class="flex h-6 w-6 sm:h-8 sm:w-8 items-center justify-center rounded-xl bg-transparent transition hover:opacity-80">
                ...
                <div class="rounded-2xl sm:rounded-3xl bg-white dark:bg-[#1F2123] p-4 sm:p-6 shadow-[0_2px_10px_rgba(0,0,0,0.02)] dark:shadow-none border border-gray-100/90 dark:border-white/5 flex flex-col justify-between lg:flex-1 lg:min-h-0">
                    <div>
                        <h2 class="text-xs sm:text-base font-semibold text-gray-900 dark:text-white mb-2.5 sm:mb-3">
                        ...
                        <div class="relative h-[150px] sm:h-[190px] lg:h-[155px] xl:h-[170px] w-full mb-2">
                            <div class="absolute inset-0 flex flex-col justify-between pointer-events-none pb-4">
                                <div class="flex items-center gap-2 sm:gap-2.5">
                                    <span class="w-7 sm:w-8 text-[9px] sm:text-[10px] text-gray-400 dark:text-[#787E87] text-right shrink-0">1M</span>
                                    <div class="h-px bg-gray-100 dark:bg-white/10 flex-1"></div>
                                </div>
                                <div class="flex items-center gap-2 sm:gap-2.5">
                                    <span class="w-7 sm:w-8 text-[9px] sm:text-[10px] text-gray-400 dark:text-[#787E87] text-right shrink-0">900jt</span>
                                    <div class="h-px bg-gray-100 dark:bg-white/10 flex-1"></div>
                                </div>
                                <div class="flex items-center gap-2 sm:gap-2.5">
                                    <span class="w-7 sm:w-8 text-[9px] sm:text-[10px] text-gray-400 dark:text-[#787E87] text-right shrink-0">800jt</span>
                                    <div class="h-px bg-gray-100 dark:bg-white/10 flex-1"></div>
                                </div>
                                <div class="flex items-center gap-2 sm:gap-2.5">
                                    <span class="w-7 sm:w-8 text-[9px] sm:text-[10px] text-gray-400 dark:text-[#787E87] text-right shrink-0">700jt</span>
                                    <div class="h-px bg-gray-100 dark:bg-white/10 flex-1"></div>
                                </div>
                                <div class="flex items-center gap-2 sm:gap-2.5">
                                    <span class="w-7 sm:w-8 text-[9px] sm:text-[10px] text-gray-400 dark:text-[#787E87] text-right shrink-0">600jt</span>
                                    <div class="h-px bg-gray-100 dark:bg-white/10 flex-1"></div>
                                </div>
                                <div class="flex items-center gap-2 sm:gap-2.5">
                                    <span class="w-7 sm:w-8 text-[9px] sm:text-[10px] text-gray-400 dark:text-[#787E87] text-right shrink-0">500jt</span>
                                    <div class="h-px bg-gray-100 dark:bg-white/10 flex-1"></div>
                                </div>
                            </div>
                            ...
                            <div class="absolute inset-0 pl-9 sm:pl-11 pb-4">
                                ...
                                <div class="absolute left-[18%] top-[45%] -translate-x-1/2 -translate-y-full pointer-events-none">
                                    <div class="relative flex flex-col items-center">
                                        <div class="bg-[#1E293B] dark:bg-[#18202F] dark:border dark:border-[#2D3F63] text-white text-[10px] sm:text-xs font-bold px-2 sm:px-3 py-1 sm:py-1.5 rounded-lg sm:rounded-xl shadow-lg flex items-center justify-center">
                                            700
                                        </div>
                                        <div class="w-2 sm:w-2.5 h-2 sm:h-2.5 bg-[#1E293B] dark:bg-[#18202F] rotate-45 -mt-1"></div>
                                    </div>
                                </div>
                            ...
                            <div class="absolute bottom-0 inset-x-0 pl-9 sm:pl-11 flex justify-between text-[9px] sm:text-[10px] text-gray-400 dark:text-[#787E87] font-medium">
                                <span>Jan</span>
                                <span>Feb</span>
                                <span>Mar</span>
                                <span>Apr</span>
                    ...
                    <div class="mt-3 sm:mt-4 pt-2.5 sm:pt-3 border-t border-gray-100/90 dark:border-white/10">
                        <h3 class="text-xs sm:text-sm font-bold text-gray-900 dark:text-white mb-1.5 sm:mb-2">
                        ...
                        <div class="overflow-x-auto no-scrollbar">
                            <table class="w-full text-left text-[10px] sm:text-xs min-w-full">
                                <thead>
                                    <tr class="text-gray-400 dark:text-[#787E87] font-normal border-b border-gray-100 dark:border-white/10 whitespace-nowrap">
                                ...
                                <tbody class="divide-y divide-gray-100 dark:divide-white/10">
                                    <tr class="whitespace-nowrap">
                                        <td class="py-1.5 sm:py-2 pr-2 font-semibold text-gray-900 dark:text-white">Kontrak Sewa</td>
                                        <td class="py-1.5 sm:py-2 px-2 text-gray-700 dark:text-gray-300">Mardiyah</td>
                                        <td class="py-1.5 sm:py-2 px-2 text-gray-700 dark:text-gray-300">24-10-2026</td>
                                        <td class="py-1.5 sm:py-2 pl-2 text-right">
                                            <span class="inline-block whitespace-nowrap rounded-md bg-[#FEECEC] dark:bg-[#E59819] px-1.5 sm:px-2.5 py-0.5 text-[9px] sm:text-xs font-semibold text-[#F04438] dark:text-[#1F2123]">
                                                4 bulan 10 hari
                                            </span>
                                        </td>
                                    </tr>
                                    <tr class="whitespace-nowrap">
                                        ...
                                        <td class="py-1.5 sm:py-2 px-2 text-gray-700 dark:text-gray-300">24-10-2026</td>
                                        <td class="py-1.5 sm:py-2 pl-2 text-right">
                                            <span class="inline-block whitespace-nowrap rounded-md bg-[#FFF4E5] dark:bg-[#E5A866] px-1.5 sm:px-2.5 py-0.5 text-[9px] sm:text-xs font-semibold text-[#F79009] dark:text-[#1F2123]">
                                                9 bulan 3 hari
                                            </span>
                                        </td>
                                    </tr>
                                    <tr class="whitespace-nowrap">
                                        ...
                                        <td class="py-1.5 sm:py-2 px-2 text-gray-700 dark:text-gray-300">24-10-2026</td>
                                        <td class="py-1.5 sm:py-2 pl-2 text-right">
                                            <span class="inline-block whitespace-nowrap rounded-md bg-[#EBFDF2] dark:bg-[#48BB78] px-1.5 sm:px-2.5 py-0.5 text-[9px] sm:text-xs font-semibold text-[#12B76A] dark:text-[#1F2123]">
                                                46 bulan 5 hari
                                            </span>
                                        </td>
                                    </tr>
            ...
            <div class="lg:col-span-4 flex flex-col gap-3.5 sm:gap-4 lg:gap-3.5 lg:min-h-0">
                ...
                <div class="rounded-2xl sm:rounded-3xl bg-white dark:bg-[#1F2123] p-4 sm:p-5.5 shadow-[0_2px_10px_rgba(0,0,0,0.02)] dark:shadow-none border border-gray-100/90 dark:border-white/5 shrink-0">
                    ...
                    <div class="flex items-center justify-between mb-2.5 sm:mb-3.5">
                        ...
                        <div class="relative">
                            <button
                                ...
                                class="flex h-7 w-7 sm:h-[32px] sm:w-[32px] items-center justify-center rounded-[8px] sm:rounded-[10px] bg-[#F5F5F7] dark:bg-[#2D3034] text-gray-400 dark:text-gray-300 hover:text-gray-600 dark:hover:text-white transition cursor-pointer shadow-xs"
                                title="Menu"
                            >
                            ...
                            <div
                                ...
                                class="hidden absolute right-0 top-full mt-1.5 w-[100px] h-[56px] bg-white dark:bg-[#2D3034] border border-gray-100 dark:border-white/10 shadow-[0_6px_24px_rgba(0,0,0,0.12)] dark:shadow-[0_6px_24px_rgba(0,0,0,0.6)] rounded-[10px] items-center justify-center gap-2 cursor-pointer hover:bg-gray-50/80 dark:hover:bg-white/5 transition z-30 select-none"
                                onclick="handleClickLihat()"
                            >
                                <x-icon name="icon-lihat" class="w-[20px] h-[20px] text-[#5A607F] dark:text-gray-300" />
                    ...
                    <div class="flex items-stretch gap-1 mb-3 sm:mb-4 h-[55px] sm:h-[70px]">
                        <div class="w-[24%] flex flex-col justify-between">
                            <span class="text-xs sm:text-base font-bold text-gray-950 dark:text-white leading-none">20%</span>
                        ...
                        <div class="w-[12%] flex flex-col justify-between">
                            <span class="text-xs sm:text-base font-bold text-gray-950 dark:text-white leading-none">10%</span>
                            <div class="flex-1 w-px bg-gray-200 dark:bg-white/15 my-1 sm:my-1.5"></div>
                            <div class="h-1 sm:h-1.5 rounded-xs bg-[#94B4FF] w-full"></div>
                        </div>

                        <div class="w-[20%] flex flex-col justify-between">
                            <span class="text-xs sm:text-base font-bold text-gray-950 dark:text-white leading-none">19%</span>
                            <div class="flex-1 w-px bg-gray-200 dark:bg-white/15 my-1 sm:my-1.5"></div>
                            <div class="h-1 sm:h-1.5 rounded-xs bg-[#EB4D4B] w-full"></div>
                        </div>

                        <div class="w-[24%] flex flex-col justify-between">
                            <span class="text-xs sm:text-base font-bold text-gray-950 dark:text-white leading-none">30%</span>
                            <div class="flex-1 w-px bg-gray-200 dark:bg-white/15 my-1 sm:my-1.5"></div>
                            <div class="h-1 sm:h-1.5 rounded-xs bg-[#F99827] w-full"></div>
                        </div>

                        <div class="w-[20%] flex flex-col justify-between">
                            <span class="text-xs sm:text-base font-bold text-gray-950 dark:text-white leading-none opacity-0">&nbsp;</span>
                            <div class="flex-1 w-px bg-gray-200 dark:bg-white/15 my-1 sm:my-1.5"></div>
                    ...
                    <div>
                        ...
                        <div class="space-y-2 sm:space-y-2.5 px-1 pt-0.5">
                            <div class="flex items-center justify-between text-[11px] sm:text-sm">
                                <span class="font-semibold text-gray-950 dark:text-white flex items-center gap-2 sm:gap-2.5">
                    ...
                    <div class="flex items-center justify-between mb-2.5 sm:mb-3 relative z-30">
                        ...
                        <div class="relative">
                            ...
                            <div
                                ...
                                class="hidden absolute right-0 top-full mt-1.5 w-[100px] h-[56px] bg-white dark:bg-[#2D3034] border border-gray-100 dark:border-white/10 shadow-[0_6px_24px_rgba(0,0,0,0.18)] dark:shadow-[0_6px_24px_rgba(0,0,0,0.6)] rounded-[10px] items-center justify-center gap-2 cursor-pointer hover:bg-gray-50/90 dark:hover:bg-white/5 transition z-40 select-none text-gray-900 dark:text-white"
