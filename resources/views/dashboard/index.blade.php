            ...
            <div class="lg:col-span-8 flex flex-col gap-4 lg:gap-3.5 lg:min-h-0">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-3.5 shrink-0">
                    ...
                    <div class="rounded-2xl sm:rounded-3xl bg-white p-4 shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-gray-100/90 flex flex-col justify-between h-[120px] sm:h-[130px] transition hover:shadow-md">
                        <div class="flex items-start justify-between">
                            <div class="flex h-9 w-9 items-center justify-center">
                                <x-icon name="ds-kontrak-aktif" class="h-9 w-9" />
                            </div>
                            <div class="flex h-8 w-8 items-center justify-center rounded-xl bg-transparent text-gray-700 transition hover:bg-gray-100">
                                <x-icon name="ds-icon-panah" class="h-8 w-8" />
                            </div>
                        </div>
                        <div>
                    ...
                    <div class="rounded-2xl sm:rounded-3xl bg-white p-4 shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-gray-100/90 flex flex-col justify-between h-[120px] sm:h-[130px] transition hover:shadow-md">
                        <div class="flex items-start justify-between">
                            <div class="flex h-9 w-9 items-center justify-center">
                                <x-icon name="ds-total-nilai-kontrak" class="h-9 w-9" />
                            </div>
                            <div class="flex h-8 w-8 items-center justify-center rounded-xl bg-transparent text-gray-700 transition hover:bg-gray-100">
                                <x-icon name="ds-icon-panah" class="h-8 w-8" />
                            </div>
                    ...
                    <div class="rounded-2xl sm:rounded-3xl bg-white p-4 shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-gray-100/90 flex flex-col justify-between h-[120px] sm:h-[130px] transition hover:shadow-md">
                        <div class="flex items-start justify-between">
                            <div class="flex h-9 w-9 items-center justify-center">
                                <x-icon name="ds-asset-disewakan" class="h-9 w-9" />
                            </div>
                            <div class="flex h-8 w-8 items-center justify-center rounded-xl bg-transparent text-gray-700 transition hover:bg-gray-100">
                                <x-icon name="ds-icon-panah" class="h-8 w-8" />
                            </div>
                    ...
                    <div class="rounded-2xl sm:rounded-3xl bg-white p-4 shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-gray-100/90 flex flex-col justify-between h-[120px] sm:h-[130px] transition hover:shadow-md">
                        <div class="flex items-start justify-between">
                            <div class="flex h-9 w-9 items-center justify-center">
                                <x-icon name="ds-rata-rata-luas-aset" class="h-9 w-9" />
                            </div>
                            <div class="flex h-8 w-8 items-center justify-center rounded-xl bg-transparent text-gray-700 transition hover:bg-gray-100">
                                <x-icon name="ds-icon-panah" class="h-8 w-8" />
                            </div>
                        ...
                        <div class="relative h-[180px] sm:h-[190px] lg:h-[155px] xl:h-[170px] w-full mb-2">
                            <div class="absolute inset-0 flex flex-col justify-between pointer-events-none pb-4">
                                <div class="flex items-center gap-2.5">
                                    <span class="w-8 text-[10px] text-gray-400 text-right shrink-0">1M</span>
                                    <div class="h-px bg-gray-100 flex-1"></div>
                                </div>
                                <div class="flex items-center gap-2.5">
                                    <span class="w-8 text-[10px] text-gray-400 text-right shrink-0">900jt</span>
                                    <div class="h-px bg-gray-100 flex-1"></div>
                                </div>
                                <div class="flex items-center gap-2.5">
                                    <span class="w-8 text-[10px] text-gray-400 text-right shrink-0">800jt</span>
                                    <div class="h-px bg-gray-100 flex-1"></div>
                                </div>
                                <div class="flex items-center gap-2.5">
                                    <span class="w-8 text-[10px] text-gray-400 text-right shrink-0">700jt</span>
                                    <div class="h-px bg-gray-100 flex-1"></div>
                                </div>
                                <div class="flex items-center gap-2.5">
                                    <span class="w-8 text-[10px] text-gray-400 text-right shrink-0">600jt</span>
                                    <div class="h-px bg-gray-100 flex-1"></div>
                                </div>
                                <div class="flex items-center gap-2.5">
                                    <span class="w-8 text-[10px] text-gray-400 text-right shrink-0">500jt</span>
                                    <div class="h-px bg-gray-100 flex-1"></div>
                                </div>
                            </div>

                            <div class="absolute inset-0 pl-11 pb-4">
                            ...
                            <div class="absolute bottom-0 inset-x-0 pl-11 flex justify-between text-[10px] text-gray-400 font-medium">
                                <span>Jan</span>
                                <span>Feb</span>
                                <span>Mar</span>
                                <span>Apr</span>
            ...
            <div class="lg:col-span-4 flex flex-col gap-4 lg:gap-3.5 lg:min-h-0">
                ...
                <div class="rounded-2xl sm:rounded-3xl bg-white p-5 sm:p-5.5 shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-gray-100/90 shrink-0">
                    ...
                    <div class="flex items-center justify-between mb-3.5">
                        ...
                        <div class="relative">
                            <button
                                ...
                                class="flex h-[32px] w-[32px] items-center justify-center rounded-[10px] bg-[#F5F5F7] text-gray-400 hover:text-gray-600 transition cursor-pointer shadow-xs"
                                title="Menu"
                            >
                    ...
                    <div class="flex items-stretch gap-1 mb-4 h-[70px]">
                        ...
                        <div class="w-[20%] flex flex-col justify-between">
                            <span class="text-sm sm:text-base font-bold text-gray-950 leading-none opacity-0">&nbsp;</span>
                            <div class="flex-1 w-px bg-gray-200 my-1.5"></div>
                            <div class="h-1.5 rounded-xs bg-[#00C49F] w-full"></div>
                        </div>
                    </div>

                    <!-- Tabel Distribusi -->
                    <div>
                        <div class="flex justify-between items-center px-1 text-xs text-[#7E8B9B] font-medium mb-2.5 pb-1 border-b border-gray-50">
                        ...
                        <div class="space-y-2.5 px-1 pt-0.5">
                            <div class="flex items-center justify-between text-xs sm:text-sm">
                                <span class="font-semibold text-gray-950 flex items-center gap-2.5">
                            ...
                            <div class="flex items-center justify-between text-xs sm:text-sm">
                                <span class="font-semibold text-gray-950 flex items-center gap-2.5">
                                    <span class="h-2 w-2 rounded-full bg-[#00C49F] shrink-0"></span>
                                    Iklan
                                </span>
                                <span class="font-medium text-[#10B981]">81.94%</span>
                            </div>
                ...
                <div class="rounded-2xl sm:rounded-3xl bg-gradient-to-b from-[#659DF8] via-[#2F7EF8] to-[#0062F5] p-5 sm:p-6 text-white shadow-[0_4px_20px_rgba(21,112,239,0.2)] flex flex-col justify-between relative lg:flex-1 lg:min-h-0">
                    
                    <div class="flex items-center justify-between mb-3 relative z-30">
                        ...
                        <div class="relative">
                            <button
                                ...
                                class="flex h-[32px] w-[32px] items-center justify-center rounded-[10px] bg-[#6697E7] hover:bg-[#5889d8] text-[#D4FCFF] transition cursor-pointer shadow-xs"
                                title="Menu"
                            >
                                <x-icon name="dots-vertical" class="w-4 h-4" />
                            </button>
