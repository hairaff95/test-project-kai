...
<body class="min-h-screen bg-[#F3F4F6] font-sans text-[#171717]">
                    ...
                    <div class="hidden sm:block overflow-hidden rounded-xl border border-gray-200 bg-white">
                        <div class="grid grid-cols-3">
                            <div class="flex min-h-[52px] items-center border-b border-r border-gray-200 bg-white">
                                ...
                                <div class="flex w-[50%] items-center justify-end px-3.5 text-right text-[11px] font-normal text-gray-800">{{ $asset->wilayah_asset }}</div>
                            </div>

                            <div class="flex min-h-[52px] items-center border-b border-r border-gray-200 bg-white">
                                <div class="w-[50%] bg-white px-3.5 py-3 text-[11px] text-gray-900 font-normal">Jenis Aset</div>
                                <div class="flex w-[50%] items-center justify-end px-3.5 text-right text-[11px] font-normal text-gray-800">{{ $asset->jenis_asset }}</div>
                            </div>

                            <div class="row-span-3 flex items-center border-b border-gray-200 bg-white">
                                <div class="w-[35%] bg-white px-3.5 py-3 text-[11px] text-gray-900 font-normal self-stretch flex items-center border-r border-gray-200">Alamat Aset</div>
                                <div class="flex w-[65%] items-center px-3.5 py-2 text-[11px] leading-[1.5] text-gray-800 font-normal">{{ $asset->description ?? ($asset->wilayah_asset . ', Stasiun ' . $asset->stasiun) }}</div>
                            </div>

                            <div class="flex min-h-[52px] items-center border-b border-r border-gray-200 bg-white">
                                <div class="w-[50%] bg-white px-3.5 py-3 text-[11px] text-gray-900 font-normal">Stasiun</div>
                                <div class="flex w-[50%] items-center justify-end px-3.5 text-right text-[11px] font-normal text-gray-800">{{ $asset->stasiun }}</div>
                            </div>

                            <div class="flex min-h-[52px] items-center border-b border-r border-gray-200 bg-white">
                                <div class="w-[50%] bg-white px-3.5 py-3 text-[11px] text-gray-900 font-normal">Luas Area</div>
                                <div class="flex w-[50%] items-center justify-end px-3.5 text-right text-[11px] font-normal text-gray-800">{{ $asset->size_area_formatted }}</div>
                            </div>

                            <div class="flex min-h-[52px] items-center border-r border-gray-200 bg-white">
                                <div class="w-[50%] bg-white px-3.5 py-3 text-[11px] text-gray-900 font-normal">Jenis Kontrak</div>
                                <div class="flex w-[50%] items-center justify-end px-3.5 text-right text-[11px] font-normal text-gray-800">{{ $contract?->jenis_kontrak ?? '-' }}</div>
                            </div>

                            <div class="flex min-h-[52px] items-center border-r border-gray-200 bg-white">
                                <div class="w-[50%] bg-white px-3.5 py-3 text-[11px] text-gray-900 font-normal">Peruntukan</div>
                                <div class="flex w-[50%] items-center justify-end px-3.5 text-right text-[11px] font-normal text-gray-800">{{ $asset->peruntukan }}</div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div id="drawer-edit" class="fixed right-0 sm:right-8 lg:right-10 top-14 sm:top-[100px] bottom-0 sm:bottom-8 z-40 w-full sm:w-[420px] max-w-full sm:max-w-[calc(100vw-40px)] rounded-t-2xl sm:rounded-2xl bg-white border border-gray-100 shadow-[0_20px_60px_rgba(0,0,0,0.18)] p-4 sm:p-6 flex flex-col justify-between overflow-hidden transform translate-x-[120%] transition-transform duration-300 ease-in-out">
        ...
        <div id="tab-content-info" class="edit-tab-container flex-1 flex flex-col overflow-hidden">
            ...
            <div id="edit-step-1" class="edit-step-content flex flex-col flex-1 overflow-hidden mt-4">
                ...
                <div class="flex items-center justify-between shrink-0 mb-4">
                    <h2 class="text-base sm:text-lg font-medium text-black">Informasi dasar aset</h2>
                    <div class="flex items-center gap-1.5">
                        <button type="button" onclick="goToInfoStep(2)" class="flex h-6 w-6 items-center justify-center rounded-[5px] bg-[#7F7F7F] text-white hover:bg-gray-600 transition cursor-pointer shadow-xs" title="Lanjut ke bagian 2">
                ...
                <div class="flex-1 overflow-y-auto pr-1 space-y-4 text-left">
                    {{-- Judul Aset --}}
                    <div>
                        <label class="block text-xs font-medium text-black mb-1.5">
                        ...
                        <input
                            ...
                            class="w-full rounded-[5px] border border-gray-200 bg-white px-3.5 py-2 text-xs sm:text-sm text-gray-800 focus:border-[#0066FF] focus:outline-none transition shadow-2xs font-normal"
                            required
                        >
                    </div>
                    ...
                    <div>
                        ...
                        <textarea
                            name="description"
                            rows="3"
                            class="w-full min-h-[85px] rounded-[5px] border border-gray-200 bg-white px-3.5 py-2 text-xs sm:text-sm text-gray-800 focus:border-[#0066FF] focus:outline-none transition resize-none shadow-2xs leading-relaxed font-normal"
                    ...
                    <div>
                        ...
                        <div class="dnd-container min-h-[85px] rounded-[5px] border border-gray-200 bg-[#EFEFEF] p-2.5 flex flex-wrap content-start gap-2 shadow-2xs">
                    ...
                    {{-- Tambahkan Wilayah Baru (Wilayah) --}}
                    <div>
                        <p class="text-[11px] text-gray-400 mb-1.5 font-medium">Tambahkan Wilayah Baru</p>
                        <button type="button" onclick="addNewDndPill(this, 'Wilayah Baru')" class="inline-flex items-center gap-1.5 rounded-[5px] bg-[#A6A6A6] hover:bg-gray-400 px-3 py-1.5 text-xs font-medium text-[#171717] transition cursor-pointer shadow-2xs">
                    ...
                    {{-- Tambahkan Aset Baru (Jenis) --}}
                    <div>
                        <p class="text-[11px] text-gray-400 mb-1.5 font-medium">Tambahkan Aset Baru</p>
                        <button type="button" onclick="addNewDndPill(this, 'Jenis Aset Baru')" class="inline-flex items-center gap-1.5 rounded-[5px] bg-[#A6A6A6] hover:bg-gray-400 px-3 py-1.5 text-xs font-medium text-[#171717] transition cursor-pointer shadow-2xs">
                            <svg class="h-3 w-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M12 5v14M5 12h14"/></svg>
            ...
            <div id="edit-step-2" class="edit-step-content hidden flex flex-col flex-1 overflow-hidden mt-4">
                ...
                <div class="flex items-center justify-between shrink-0 mb-4">
                    <h2 class="text-base sm:text-lg font-medium text-black">Luas Aset<span class="text-red-500">*</span></h2>
                    <div class="flex items-center gap-1.5">
                        <button type="button" onclick="goToInfoStep(1)" class="flex h-6 w-6 items-center justify-center rounded-[5px] bg-[#7F7F7F] text-white hover:bg-gray-600 transition cursor-pointer shadow-xs" title="Kembali ke bagian 1">
                            <svg class="h-3.5 w-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M15 18l-6-6 6-6"/>
                            </svg>
                        </button>
                        <button type="button" onclick="goToInfoStep(3)" class="flex h-6 w-6 items-center justify-center rounded-[5px] bg-[#7F7F7F] text-white hover:bg-gray-600 transition cursor-pointer shadow-xs" title="Lanjut ke bagian 3">
                            <svg class="h-3.5 w-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M9 18l6-6-6-6"/>
                            </svg>
                        </button>
                ...
                <div class="flex-1 overflow-y-auto pr-1 space-y-4 text-left">
                    ...
                    {{-- Tambahkan Kontrak Baru (Kontrak) --}}
                    <div>
                        <p class="text-[11px] text-gray-400 mb-1.5 font-medium">Tambahkan Kontrak Baru</p>
                        <button type="button" onclick="addNewDndPill(this, 'Kontrak Baru')" class="inline-flex items-center gap-1.5 rounded-[5px] bg-[#A6A6A6] hover:bg-gray-400 px-3 py-1.5 text-xs font-medium text-[#171717] transition cursor-pointer shadow-2xs">
                            <svg class="h-3 w-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M12 5v14M5 12h14"/></svg>
                    ...
                    {{-- Tambahkan Stasiun Baru (Stasiun) --}}
                    <div>
                        <p class="text-[11px] text-gray-400 mb-1.5 font-medium">Tambahkan Stasiun Baru</p>
                        <button type="button" onclick="addNewDndPill(this, 'Stasiun Baru')" class="inline-flex items-center gap-1.5 rounded-[5px] bg-[#A6A6A6] hover:bg-gray-400 px-3 py-1.5 text-xs font-medium text-[#171717] transition cursor-pointer shadow-2xs">
                            <svg class="h-3 w-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M12 5v14M5 12h14"/></svg>
            ...
            <div id="edit-step-3" class="edit-step-content hidden flex flex-col flex-1 overflow-hidden mt-4">
                ...
                <div class="flex items-center justify-between shrink-0 mb-3">
                    <h2 class="text-base sm:text-lg font-medium text-black">Tambah Gambar<span class="text-red-500">*</span></h2>
                    <div class="flex items-center gap-1.5">
                        <button type="button" onclick="goToInfoStep(2)" class="flex h-6 w-6 items-center justify-center rounded-[6px] bg-[#7F7F7F] text-white hover:bg-gray-600 transition cursor-pointer shadow-xs" title="Kembali ke bagian 2">
                            <svg class="h-3.5 w-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M15 18l-6-6 6-6"/>
                            </svg>
                        </button>
                        <button type="button" disabled class="flex h-6 w-6 items-center justify-center rounded-[6px] bg-[#A6A6A6] text-white cursor-not-allowed opacity-60">
                            <svg class="h-3.5 w-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M9 18l6-6-6-6"/>
                            </svg>
                        </button>
                ...
                <div class="flex-1 overflow-y-auto pr-1 space-y-4 text-left">
                    ...
                    <div onclick="document.getElementById('file-upload-input').click()" class="rounded-2xl border-2 border-dashed border-gray-300 py-8 px-5 flex flex-col items-center justify-center text-center hover:bg-gray-50/70 transition cursor-pointer">
                        ...
                        <x-icon name="icon-upload-gambar" class="w-16 h-16 mb-2.5 text-[#4F4F4F]" />
                        <p class="text-xs sm:text-[13px] font-medium text-black">Klik ikon untuk tambah gambar dibawah 10 MB</p>
                        <p class="text-[11px] text-gray-400 mt-0.5 font-normal">pilih dalam format JPEG, JPG, PNG, WEBP</p>
                    </div>
                    ...
                    <div id="image-dnd-wrapper" class="space-y-3">
                        {{-- Slot Utama --}}
                        <div>
                            <label class="block text-xs font-medium text-black mb-1.5">Utama</label>
                    ...
                    <div class="pt-2">
                        ...
                        <div class="grid grid-cols-[140px_1fr] sm:grid-cols-[165px_1fr] gap-3.5 items-center">
                            <div class="h-[145px] sm:h-[160px] w-full rounded-2xl overflow-hidden border border-gray-200 bg-gray-100 relative shadow-2xs">
                                <div id="edit-map-preview" class="w-full h-full z-0"></div>
                            </div>

                            <div class="space-y-3">
                                <div>
                                    <label class="block text-xs font-medium text-black mb-1">Latitude</label>
                                    <input
                                        type="text"
                                        ...
                                        placeholder="-6.88856"
                                        class="w-full rounded-[8px] border border-gray-200 bg-white px-3.5 py-2 text-xs sm:text-sm text-gray-800 focus:border-[#0066FF] focus:outline-none transition shadow-2xs font-normal"
                                    >
                                </div>
                                <div>
                                    <label class="block text-xs font-medium text-black mb-1">Longtitude</label>
                                    <input
                                        type="text"
        ...
        <div id="tab-content-admin" class="edit-tab-container hidden flex-1 flex flex-col overflow-hidden mt-4">
            ...
            <div class="flex items-center justify-between shrink-0 mb-4">
                <h2 class="text-base sm:text-lg font-medium text-black">Data administratif</h2>
                <button
                    type="button"
                    onclick="closeEditDrawer()"
            ...
            <div class="flex-1 overflow-y-auto pr-1 space-y-3.5 text-left">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input
                                ...
                                class="w-full rounded-[5px] border border-gray-200 bg-white pl-8 pr-3 py-2 text-xs sm:text-sm text-gray-800 focus:border-[#0066FF] focus:outline-none transition shadow-2xs font-normal"
                            >
                            <button
                                type="button"
                ...
                <div>
                    <p class="text-[11px] text-gray-400 mb-1.5 font-medium">Tambahkan Keterangan Baru</p>
                    <button type="button" onclick="addNewDndPill(this, 'Keterangan Baru')" class="inline-flex items-center gap-1.5 rounded-[5px] bg-[#A6A6A6] hover:bg-gray-400 px-3 py-1.5 text-xs font-medium text-[#171717] transition cursor-pointer shadow-2xs">
                        <svg class="h-3 w-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M12 5v14M5 12h14"/></svg>
        ...
        <div id="tab-content-finansial" class="edit-tab-container hidden flex-1 flex flex-col overflow-hidden mt-4">
            ...
            <div class="flex items-center justify-between shrink-0 mb-4">
                <h2 class="text-base sm:text-lg font-medium text-black">Data Finansial</h2>
                <button
                    type="button"
                    onclick="closeEditDrawer()"
                    class="inline-flex items-center gap-1.5 rounded-[8px] bg-[#0066FF] hover:bg-blue-700 px-4 py-1.5 text-xs sm:text-sm font-medium text-white shadow-xs transition active:scale-95 cursor-pointer"
            ...
            <div class="flex-1 overflow-y-auto pr-1 space-y-3.5 text-left">
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div>
                        ...
                        <input
                            ...
                            class="w-full rounded-[5px] border border-gray-200 bg-white px-3 py-1.5 text-xs sm:text-sm text-gray-800 focus:border-[#0066FF] focus:outline-none transition shadow-2xs font-normal"
                        >
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input
                                ...
                                class="w-full rounded-[5px] border border-gray-200 bg-white pl-8 pr-3 py-1.5 text-xs sm:text-sm text-gray-800 focus:border-[#0066FF] focus:outline-none transition shadow-2xs font-normal"
                            >
                            <button
                                type="button"
                ...
                {{-- Nilai Per Bulan --}}
                <div class="pt-2">
                    <h3 class="text-xs sm:text-sm font-medium text-black mb-2.5">Nilai Per Bulan</h3>
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <div class="space-y-2.5">
                            @foreach($months1 as [$label, $col, $default])
                                <div>
                                    <label class="block text-[11px] text-gray-500 mb-1 font-medium">{{ $label }}</label>
                                    <input
                                        type="text"
                                        name="{{ $col }}"
                                        value="{{ $monthly ? number_format((float)$monthly->$col, 0, ',', '.') : $default }}"
                                        class="w-full rounded-[5px] border border-gray-200 bg-white px-3 py-1.5 text-xs text-gray-800 focus:border-[#0066FF] focus:outline-none transition shadow-2xs font-normal"
                                    >
                                </div>
                            @endforeach
                        </div>
    ...
    <div id="modal-hapus" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
        <div class="w-[380px] rounded-2xl bg-white p-6 shadow-xl">
            ...
            <div class="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-red-100">
                <x-icon name="trash-line" class="w-6 h-6 text-red-600" />
            </div>
            ...
            <div class="flex gap-3">
                <button type="button" onclick="document.getElementById('modal-hapus').classList.add('hidden')"
                    class="flex-1 rounded-xl border border-gray-200 bg-white py-2.5 text-[13px] font-semibold text-gray-700 transition hover:bg-gray-50 cursor-pointer">
                    Batal
                </button>
                <button type="button" onclick="document.getElementById('form-hapus-aset').submit()"
                    class="flex-1 rounded-xl bg-red-500 py-2.5 text-[13px] font-semibold text-white transition hover:bg-red-600 cursor-pointer">
                    Ya, Hapus
                </button>
            </div>
    ...
    <script>
        ...
        function switchEditTab(tab) {
            ...
            tabs.forEach(t => {
                ...
                if (t === tab) {
                    btn.className = "font-medium text-[#0066FF] border-b-2 border-[#0066FF] pb-2 -mb-3 transition cursor-pointer";
                    content.classList.remove('hidden');
                } else {
                    btn.className = "font-medium text-gray-500 hover:text-gray-800 pb-2 -mb-3 transition cursor-pointer";
        ...
        function addNewDndPill(button, defaultName = 'Kolom Baru') {
            ...
            if (container && container.classList.contains('dnd-container')) {
                ...
                newPill.className = 'dnd-pill h-8 w-auto inline-flex items-center gap-2 rounded-[5px] border border-gray-300 bg-white px-2.5 sm:px-3 text-xs text-gray-700 shadow-2xs cursor-grab active:cursor-grabbing select-none transition-all duration-150 shrink-0';
                newPill.innerHTML = `
                    <x-icon name="icon-drag-n-drop" class="w-3.5 h-3.5 text-gray-500 shrink-0 pointer-events-none" />
        ...
        function renderImageList() {
            ...
            if (uploadedImages.length === 0) {
                utamaSlot.innerHTML = `<div class="text-xs text-gray-400 p-4 border border-dashed rounded-xl text-center">Belum ada gambar</div>`;
            ...
            utamaSlot.innerHTML = `
                <div draggable="true" 
                     ...
                     class="image-dnd-card rounded-xl border border-gray-200 bg-white p-3 flex items-center justify-between shadow-2xs cursor-grab active:cursor-grabbing hover:border-blue-400 transition select-none">
                    <div class="flex items-center gap-3 overflow-hidden">
                        <div class="w-14 h-14 rounded-lg bg-[#d8d8d8] shrink-0 flex items-center justify-center text-gray-400">
                        ...
                        <div class="truncate">
                            <p class="text-sm font-medium text-black truncate">${mainImg.name}</p>
                            <p class="text-xs text-gray-400 mt-0.5">${mainImg.size}</p>
                        </div>
                    </div>
            ...
            secondaryGrid.innerHTML = uploadedImages.slice(1).map((img, idx) => {
                ...
                return `
                    <div draggable="true" 
                         ...
                         class="image-dnd-card rounded-xl border border-gray-200 bg-white p-2.5 flex items-center justify-between shadow-2xs cursor-grab active:cursor-grabbing hover:border-blue-400 transition select-none">
                        <div class="flex items-center gap-2.5 overflow-hidden">
                            <div class="w-11 h-11 rounded-lg bg-[#d8d8d8] shrink-0 flex items-center justify-center text-gray-400">
                            ...
                            <div class="truncate">
                                <p class="text-xs font-medium text-black truncate">${img.name}</p>
                                <p class="text-[10px] text-gray-400 mt-0.5">${img.size}</p>
                            </div>
                        </div>
