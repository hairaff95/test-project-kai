                        ...
                        <div class="space-y-2 sm:space-y-3">
                            ...
                            <div class="flex flex-col w-full">
                                ...
                                <textarea
                                    ...
                                    rows="2"
                                    class="w-full min-h-[44px] sm:min-h-[60px] rounded-xl border border-gray-200 bg-white px-2.5 sm:px-3 py-1.5 text-[11px] sm:text-xs text-gray-800 focus:border-[#0066FF] focus:outline-none transition resize-none shadow-2xs leading-relaxed font-normal"
                                    required
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                                    {{-- Mulai --}}
                                    <div class="flex flex-col w-full">
                                        <label class="block text-[10px] sm:text-[11px] text-gray-400 mb-0.5">Mulai</label>
                                        <div class="relative">
                                            <button
                                                type="button"
                                    ...
                                    {{-- Selesai --}}
                                    <div class="flex flex-col w-full">
                                        <label class="block text-[10px] sm:text-[11px] text-gray-400 mb-0.5">Selesai</label>
                                        <div class="relative">
                                            <button
                                                type="button"
